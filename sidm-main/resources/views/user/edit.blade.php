                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror"
                                            value="{{ old('name', $user->name) }}" name="name" type="text"
                                            id="name" class="form-control" name="name" required>
                                        @error('name')
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('repassword') is-invalid @enderror" value=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class="form-select" name="level" id="basicSelect">
                                                ...
                                                <option value="poli" {{ $user->level == 'poli' ? 'selected' : '' }}>
                                                    Poli
                                                </option>
                                                <option value="sik" {{ $user->level == 'sik' ? 'selected' : '' }}>
                                                    SIK
                                                </option>
                                                <option value="pasien" {{ $user->level == 'pasien' ? 'selected' : '' }}>
                                                    Pasien
                                                </option>
                                            </select>
                                        </div>
