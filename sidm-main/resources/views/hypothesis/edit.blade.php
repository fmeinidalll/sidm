            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical " method="post"
                        action="{{ route('hypothesis.update', $hypothesis->id) }}">
                        @method('patch')
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="code" value="{{ $hypothesis->code }}"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name"
                                            ...
                                            value="{{ old('name', $hypothesis->name) }}" id="name" name="name"
                                            required>
                                        @error('name')
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                            rows="3">{{ old('description', $hypothesis->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                <i class="bx bx-radio-circle"></i>
                                                {{ $message }}.
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        <label for="solution" class="form-label">Rekomendasi</label>
